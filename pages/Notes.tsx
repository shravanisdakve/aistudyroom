  ...
  return (
    <Modal isOpen={isOpen} onClose={onClose} title="Add New Resource">
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <Input
          placeholder={noteType === 'file' ? "Title (Optional)" : "Note Title"}
          value={title}
        ...
        <Button type="submit" isLoading={isSubmitting} className="w-full" disabled={isSubmitting || (noteType === 'file' && !file) || (noteType === 'text' && !title)}>
